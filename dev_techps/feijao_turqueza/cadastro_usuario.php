...
function cadastra_usuario() {
	...
	$expiracao = ($_POST['expiracao'] == '') ? '0000-00-00' : $_POST['expiracao'];
	$valores = array($_POST[nome], $_POST[login], $_POST[nivel], 'ativo', $_POST[nascimento], $_POST[cpf], $_POST[rg], $_POST[cidade], $_POST[email], $_POST[empresa], $expiracao);
