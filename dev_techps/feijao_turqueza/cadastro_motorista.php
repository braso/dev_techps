...
// 	die();
	...
	$valores = array(
		$_POST[nome], $nascimento, $_POST[cpf], $_POST[rg], $_POST[civil], $_POST[sexo], $_POST[endereco], $_POST[numero], $_POST[complemento],
	...
	$consulta_matricula = ($_POST[matricula] != '') ?  NULL : query("SELECT * FROM `entidade` WHERE enti_tx_tipo = 'Motorista' AND enti_tx_matricula = '$matricula'");
	if (!$_POST[id]) {
...
// 	die();
    ...
    $cnhEmissao = ($_POST[cnhEmissao] === '') ? '0000-00-00' : $_POST[cnhEmissao];
		...
		$valores2 = array(
			...
			$nascimento, $_POST[cpf], $_POST[rg], $cidade, $_POST[email], $_POST[empresa],
...
function index() {
	...
	if ($_POST[busca_padrao] && $_POST[busca_padrao] != 'Todos')
		$having .= " HAVING enti_tx_ehPadrao = '$_POST[busca_padrao]'";
	else if ($_POST[busca_padrao] === 'Todos')
	    $having .= "";
