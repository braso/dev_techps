	...
	if ($_POST[busca_data] && $_POST[busca_empresa]) {
		...
		while ($aMotorista = carrega_array($sqlMotorista)) {
			...
			for ($i = 1; $i <= $daysInMonth; $i++) {
				...
				$aDetalhadoCampos = [$aDetalhado['data'],$aDetalhado['diaSemana'],$aDetalhado['inicioJornada'],$aDetalhado['inicioRefeicao'],
			...
			<body>
				...
				<table class="table" border="1">
					...
					<tbody>
						...
						<!--    <td><b>TOTAL:</b></td>-->
						<!--    <td><b>< -->
						<!--    $totalResumo['diffJornadaEfetiva']?></b></td>-->
						<!--    <td><</td>-->
						<!--    <td>< -->
						<!--    $totalResumo['intersticio']?></td>-->
						<!--    <td></td>-->
						<!--    <td></td>-->
						<!--    <td></td>-->
						<!--    <td></td>-->
...
function index() {
	...
	$c[] = combo('Endosso:', 'busca_endossado', $_POST[busca_endossado], 2, array('Todos', 'Endossado', 'Não endossado'));
