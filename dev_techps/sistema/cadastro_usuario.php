<?php
	...
	function layout_usuario(){
		...
		$extra .= is_bool(strpos($_SESSION['user_tx_nivel'], 'Administrador')) ? 'disabled' : '';
		
		if ($_SESSION['user_tx_nivel'] === 'Super Administrador') {
			$combo = ['Super Administrador', 'Administrador', 'Funcionário', 'Motorista'];
			...
			$combo = ['Administrador', 'Funcionário', 'Motorista'];
		}
