<?php
	...
	function data_extenso($data){
		...
		// return utf8_encode(strftime('%d de %B de %Y', strtotime($data))); (Deprecated)
		return mb_convert_encoding(IntlDateFormatter::formatObject(strtotime($data), '%d de %B de %Y'), 'UTF-8');
	}
