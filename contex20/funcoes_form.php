<?php
		...
		?>
			...
			<html lang="pt-br">
				...
				<head>
					...
					<link href="<?php echo $CONTEX['path']?>/../contex20/assets/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
					<link href="<?php echo $CONTEX['path']?>/../contex20/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
							...
							<div class="page-head">
								<div class="container-fluid">
									...
									<div class="page-title">
										<h1><?php echo $nome_pagina.(is_int(strpos($_SERVER["REQUEST_URI"], 'dev_'))? ' (Dev)': '')?> </h1>
									</div>
									<!-- FIM PAGE TITLE -->
								</div>
							</div>
	...
	function rodape(){
		...
		?>
				...
				<form id="loginTimeoutForm" method="post" target="https://braso.mobi<?php echo $CONTEX['path']?>/logout.php" action="logout"></form>
