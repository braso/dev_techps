...
<input type="hidden" id="goto_uri" value="/cPanel_magic_revision_1684439342/frontend/jupiter/js/filemanager_optimized.js" />
...
<script>
    var MESSAGES = {"authenticating":"Autenticando…","no_username":"Você deve especificar um nome de usuário para fazer login.","network_error":"Ocorreu um erro de rede durante sua solicitação de login. Tente novamente. Se essa condição persistir, contate o provedor de serviços de rede.","read_below":"Leia as importantes informações abaixo.","internal_error":"An internal error occurred. If this condition persists, contact the system administrator.","success":"Login bem-sucedido. Redirecionando…","invalid_login":"O login é inválido.","ajax_timeout":"O tempo de conexão esgotou. Tente novamente.","session_locale":"A localidade desejada foi salva no seu navegador. Para alterar a localidade neste navegador novamente, selecione outra localidade nesta tela."};
