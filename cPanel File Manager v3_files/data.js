...
<head>
    ...
    <link href="/cPanel_magic_revision_1684439341/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1684439341/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
...
<input type="hidden" id="goto_uri" value="/cPanel_magic_revision_1684439341/yui-gen/data/data.js" />
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1684438239/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
                O JavaScript está desabilitado no seu navegador.
                Para que cPanel funcione corretamente, você deve habilitar o JavaScript.
                Se você não habilitar o JavaScript, determinados recursos em cPanel não funcionarão corretamente.
            </div>
            </noscript>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1684438239/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
...
<script>
    var MESSAGES = {"invalid_login":"O login é inválido.","success":"Login bem-sucedido. Redirecionando…","read_below":"Leia as importantes informações abaixo.","internal_error":"An internal error occurred. If this condition persists, contact the system administrator.","network_error":"Ocorreu um erro de rede durante sua solicitação de login. Tente novamente. Se essa condição persistir, contate o provedor de serviços de rede.","no_username":"Você deve especificar um nome de usuário para fazer login.","authenticating":"Autenticando…","session_locale":"A localidade desejada foi salva no seu navegador. Para alterar a localidade neste navegador novamente, selecione outra localidade nesta tela.","ajax_timeout":"O tempo de conexão esgotou. Tente novamente."};
