		...
		function menu_estrutura_do_nivel($nivel): array{
			...
			$paginas = [
				"cadastros" => [
					...
					"/documentos/termos/modelos_termo.php" => "Modelos de Termos",
					"/documentos/termos/gerar_termos.php" => "Gerar Termos",
					"/documentos/termos/listar_termos.php" => "Termos Gerados",
