...
<div class="assinatura-dashboard">
    ...
    <div class="cards-grid">
        ...
        <!-- Envio Múltiplo -->
        <div class="card-wrapper">
            <a href="<?php echo $baseAssinatura; ?>/governanca.php" class="card-modulo">
                <div class="card-border-top"></div>
                <div class="card-body-content">
                    <div class="icon-circle">
...
-->
        ...
        <!-- Documentos -->
        <div class="card-wrapper">
            <a href="<?php echo $baseAssinatura; ?>/documentos.php" class="card-modulo">
                <div class="card-border-top"></div>
                <div class="card-body-content">
                    <div class="icon-circle">
                    ...
                    <div class="card-desc">Lista os documentos por funcionário (pasta + cadastro).</div>
                </div>
            </a>
        </div>
