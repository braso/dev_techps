	...
	function buscarEspelho(){
        ...
        $motoristas = mysqli_fetch_all(query(
            "SELECT * FROM entidade
                ...
                LEFT JOIN user u ON u.user_nb_entidade = entidade.enti_nb_id AND u.user_tx_status = 'ativo'
                LEFT JOIN usuario_perfil up ON up.user_nb_id = u.user_nb_id AND up.ativo = 1
                LEFT JOIN perfil_menu_item pmi ON pmi.perfil_nb_id = up.perfil_nb_id AND pmi.perm_ver = 1
                LEFT JOIN menu_item mi ON mi.menu_nb_id = pmi.menu_nb_id AND mi.menu_tx_ativo = 1 AND mi.menu_tx_path = '/batida_ponto.php'
