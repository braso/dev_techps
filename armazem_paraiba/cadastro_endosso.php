		...
		?><script>
			function selecionaMotorista(idEmpresa) {
				...
				$('.busca_motorista').select2({
					...
					allowClear: true,
					ajax: {
						url: "<?php echo$_ENV['URL_BASE']?>/contex20/select2.php?path=<?php echo $_ENV["APP_PATH"]?>&tabela=entidade&extra_ordem=&extra_limite=15&extra_bd="+buscaExtra+"&extra_busca=enti_tx_matricula",
						dataType: 'json',
						delay: 250,
