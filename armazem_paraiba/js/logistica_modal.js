...
function atualizarResumo() {
    var table = document
        .getElementById("adjustmentTable")
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        resumo.appendChild(
            document.createTextNode(
                ` Hora Início: ${horaInicio}, Hora Fim: ${horaFim}, Tipo de Ajuste: ${tipoAjusteNome}  - `
            )
        );
    ...
    .addEventListener("click", function () {
        ...
        if (
            ...
            if (horaFim) {
                ...
                newRowFim.insertCell(5).textContent =
                    idMacro == "3"
                        ? "4"
                        : idMacro == "5"
                        ? "6"
...
document
    .getElementById("submitAdjustmentsBtn")
    .addEventListener("click", function () {
        var table = document
            .getElementById("adjustmentTable")
            .getElementsByTagName("tbody")[0];
...
setTimeout(function () {
    console.log(
        "5 segundos se passaram, ocultando mensagens e redirecionando."
    );
