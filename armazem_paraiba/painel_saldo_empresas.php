...
if ($quantMeta != 0) {
    $porcentagenMeta  = number_format(($quantMeta / count($empresasTotais)) * 100, 2);
}
if ($quantNega != 0) {
    $porcentagenNega = number_format(($quantNega / count($empresasTotais)) * 100, 2);
}
if ($quantPosi != 0) {
    $porcentagenPosi = number_format(($quantPosi / count($empresasTotais)) * 100, 2);
}
                    ...
                    <thead>
                        <tr class="totais">
                            ...
                            if ($empresas != null) {
                                ...
                                echo "<th colspan='1'> $empresas[EmprTotalJorEfe]</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalHE50'] == '00:00') ? '' : $empresas['EmprTotalHE50']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalHE100'] == '00:00') ? '' : $empresas['EmprTotalHE100']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalAdicNot'] == '00:00') ? '' : $empresas['EmprTotalAdicNot']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalEspInd'] == '00:00') ? '' : $empresas['EmprTotalEspInd']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalSaldoAnter'] == '00:00') ? '' : $empresas['EmprTotalSaldoAnter']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalSaldoPeriodo'] == '00:00') ? '' : $empresas['EmprTotalSaldoPeriodo']) . "</th>";
                                echo "<th colspan='1'> " . (($empresas['EmprTotalSaldoFinal'] == '00:00') ? '' : $empresas['EmprTotalSaldoFinal']) . "</th>";
                            }
                            ?>
                        </tr>
