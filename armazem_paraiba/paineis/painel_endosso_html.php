                ...
                <table id='tabela-motorista' class='table w-auto text-xsmall table-bordered table-striped table-condensed flip-content table-hover compact'>
                    <thead>
                        ...
                        <tr id='ti' class='titulos'>
                            <?php
                            if (isset($_POST['empresa']) && !empty($_POST['empresa']) && isset($_POST['busca_data']) && !empty($_POST['busca_data'])) {
                                echo "<th data-column='motorista' data-order='asc'></th>"
                                    . "<th data-column='motorista' data-order='asc'></th>"
                                    . "<th data-column='statusEndosso' data-order='asc'></th>"
                                    . "<th data-column='jornadaPrevista' data-order='asc'></th>"
                                    . "<th data-column='jornadaEfetiva' data-order='asc'></th>"
                                    . "<th data-column='he50' data-order='asc'></th>"
                                    . "<th data-column='he100' data-order='asc'></th>"
                                    . "<th data-column='adicionalNoturno' data-order='asc'></th>"
                                    . "<th data-column='esperaIndenizada' data-order='asc'></th>"
                                    . "<th data-column='saldoAnterior' data-order='asc'></th>"
                                    . "<th data-column='saldoPeriodo' data-order='asc'></th>"
                                    . "<th data-column='saldoFinal' data-order='asc'></th>";
                            } else {
                                echo "<th data-column='empresaNome' data-order='asc'></th>"
                                    . "<th data-column='porcentagem' data-order='asc'></th>"
                                    . "<th data-column='totalMotorista' data-order='asc'></th>"
                                    . "<th data-column='jornadaPrevista' data-order='asc'></th>"
                                    . "<th data-column='JornadaEfetiva	' data-order='asc'></th>"
                                    . "<th data-column='he50' data-order='asc'></th>"
                                    . "<th data-column='he100' data-order='asc'></th>"
